...
use crate::jex::instructions::operators::{ADD_INSTRUCTION, DIVIDE_INSTRUCTION, EQUAL_INSTRUCTION, FALSE_INSTRUCTION, GREATER_INSTRUCTION, LESS_INSTRUCTION, MULTIPLY_INSTRUCTION, NEGATE_INSTRUCTION, NOT_INSTRUCTION, NULL_INSTRUCTION, PRINT_INSTRUCTION, SUBTRACT_INSTRUCTION, TRUE_INSTRUCTION, TO_STRING_INSTRUCTION};
...
pub const JEX_INSTRUCTIONS: [&'static JexInstruction; 26] = [
    &NEGATE_INSTRUCTION,
    &ADD_INSTRUCTION,
